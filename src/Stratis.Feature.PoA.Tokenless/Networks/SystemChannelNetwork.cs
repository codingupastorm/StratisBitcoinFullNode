...
{
    public sealed class SystemChannelNetwork : ChannelNetwork
    {
        ...
        public SystemChannelNetwork()
        {
            ...
            TokenlessConsensusRuleSet.CreateForSystemChannel(this);
        ...
        public static ChannelNetwork CreateChannelNetwork(string name, string channelIdentifier, string rootFolderName, long genesisTime)
        {
            ...
            {
                Base58Prefixes = systemChannelNetwork.Base58Prefixes,
                DefaultAPIPort = systemChannelNetwork.DefaultAPIPort,
                DefaultBanTimeSeconds = systemChannelNetwork.DefaultBanTimeSeconds,
                DefaultConfigFilename = systemChannelNetwork.DefaultConfigFilename,
                DefaultEnableIpRangeFiltering = systemChannelNetwork.DefaultEnableIpRangeFiltering,
                DefaultMaxInboundConnections = systemChannelNetwork.DefaultMaxInboundConnections,
            ...
            channelNetwork.Consensus = systemChannelNetwork.Consensus;
