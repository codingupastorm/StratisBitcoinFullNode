...
namespace Stratis.Feature.PoA.Tokenless.Endorsement
{
    ...
    /// Delegates to <see cref="EndorsementPolicyValidator"/> and <see cref="EndorsementSignatureValidator"/> for validation of the policies and signatures respectively.
    /// </summary>
    public class EndorsementValidator : IEndorsementValidator
    {
        ...
        public bool Validate(ReadWriteSet rws, IEnumerable<Endorsement> endorsements)
        {
            ...
            var policyValidator = new EndorsementPolicyValidator(policy);
