...
namespace Stratis.Features.Consensus.Rules.ProvenHeaderRules
{
    ...
    /// <seealso cref="T:Stratis.Features.Consensus.Rules.ProvenHeaderRules.ProvenHeaderRuleBase" />
    public class ProvenHeaderCoinstakeRule : ProvenHeaderRuleBase
    {
        ...
        protected override void ProcessRule(PosRuleContext context, ChainedHeader chainedHeader, ProvenBlockHeader header)
        {
            ...
            if (!header.Coinstake.IsCoinStake)
            {
                ...
                if (chainedHeader.Height > this.Parent.Network.Consensus.ConsensusMiningReward.LastPOWBlock)
                {
