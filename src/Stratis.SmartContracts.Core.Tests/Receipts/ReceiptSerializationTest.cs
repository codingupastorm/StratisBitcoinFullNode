...
namespace Stratis.SmartContracts.Core.Tests.Receipts
{
    public class ReceiptSerializationTest
    {
        ...
        public void Receipt_Serializes_And_Deserializes()
        {
            ...
            receipt = new Receipt(receipt.PostState, receipt.GasUsed, receipt.Logs, new uint256(12345), new uint160(25), new uint160(24), new uint160(23), true, null, null, 54321, 1_000_000, "RWS", "MethodName", null) { BlockHash = new uint256(1234) };
            ...
            TestStorageSerialize(receipt);
            receipt = new Receipt(receipt.PostState, receipt.GasUsed, receipt.Logs, new uint256(12345), new uint160(25), null, new uint160(23), true, "Test Result 2", "Test Error Message 2", 54321, 1_000_000, "RWS", null, 169) { BlockHash = new uint256(1234) };
            TestStorageSerialize(receipt);
        }
        ...
        public byte[] ToStorageBytesRlp_NoMethodName(Receipt receipt)
        {
            ...
            return RLP.EncodeList(
                ...
                RLP.EncodeElement(Encoding.UTF8.GetBytes(receipt.ReadWriteSet ?? ""))
            );
        }
