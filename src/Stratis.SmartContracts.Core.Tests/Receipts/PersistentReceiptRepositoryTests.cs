...
namespace Stratis.SmartContracts.Core.Tests.Receipts
{
    public class PersistentReceiptRepositoryTests
    {
        ...
        public PersistentReceiptRepositoryTests()
        {
            ...
            var keyValueStore = new PersistentReceiptKVStore(new DBreezeSerializer(KnownNetworks.StratisTest.Consensus.ConsensusFactory), dataFolder, new LoggerFactory(), DateTimeProvider.Default);
