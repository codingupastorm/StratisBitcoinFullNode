    ...
    public class BlockStoreTests
    {
        ...
        public async Task BlockStoreCanReorgAsync()
        {
            ...
            using (var nodeBuilder = SmartContractNodeBuilder.Create(testRootFolder))
            {
                ...
                CoreNode nodeSync = nodeBuilder.CreateTokenlessNode(network, 0, server, permissions: FederationPermissions).Start();
                ...
                CoreNode node1 = nodeBuilder.CreateTokenlessNode(network, 1, server, permissions: FederationPermissions).Start();
                CoreNode node2 = nodeBuilder.CreateTokenlessNode(network, 2, server, permissions: FederationPermissions).Start();
