...
namespace Stratis.SmartContracts.CLR.Tests
{
    public class StateTransitionSpecification
    {
        ...
        public void ExternalCreate_Success()
        {
            ...
            this.vm.Setup(v => v.Create(this.contractStateRoot.Object, It.IsAny<ISmartContractState>(), It.IsAny<ExecutionContext>(), externalCreateMessage.Code, new EndorsementPolicy(), externalCreateMessage.Parameters, null))
            ...
            this.vm.Verify(v => v.Create(this.contractStateRoot.Object, It.IsAny<ISmartContractState>(), It.IsAny<ExecutionContext>(), externalCreateMessage.Code, new EndorsementPolicy(), externalCreateMessage.Parameters,  null), Times.Once);
        ...
        public void ExternalCall_Success()
        {
            ...
            state.Verify(s => s.CreateSmartContractState(state.Object, It.IsAny<ReadWriteSetBuilder>(), It.IsAny<ReadWriteSetBuilder>(), It.IsAny<RuntimeObserver.IGasMeter>(), externalCallMessage.To, externalCallMessage, this.contractStateRoot.Object));
        ...
        public void InternalCreate_Success()
        {
            ...
            this.vm.Setup(v => v.Create(this.contractStateRoot.Object, It.IsAny<ISmartContractState>(), It.IsAny<ExecutionContext>(), code, new EndorsementPolicy(), internalCreateMessage.Parameters, internalCreateMessage.Type))
                .Returns(vmExecutionResult);
            ...
            this.vm.Verify(v => v.Create(this.contractStateRoot.Object, It.IsAny<ISmartContractState>(), It.IsAny<ExecutionContext>(), code, new EndorsementPolicy(), internalCreateMessage.Parameters, internalCreateMessage.Type), Times.Once);
        ...
        public void Create_Out_Of_Gas_Error()
        {
            ...
            this.vm.Setup(v => v.Create(this.contractStateRoot.Object, It.IsAny<ISmartContractState>(), It.IsAny<ExecutionContext>(), createMessage.Code, new EndorsementPolicy(), createMessage.Parameters, null))
                .Returns(vmExecutionResult);
            ...
            this.vm.Verify(v => v.Create(this.contractStateRoot.Object, It.IsAny<ISmartContractState>(), It.IsAny<ExecutionContext>(), createMessage.Code, new EndorsementPolicy(), createMessage.Parameters, null), Times.Once);
        ...
        public void InternalCall_Success()
        {
            ...
            // Verify we set up the smart contract state
            state.Verify(s => s.CreateSmartContractState(state.Object, It.IsAny<ReadWriteSetBuilder>(), It.IsAny<ReadWriteSetBuilder>(), It.IsAny<RuntimeObserver.IGasMeter>(), internalCallMessage.To, internalCallMessage, this.contractStateRoot.Object));
        ...
        public void Call_Out_Of_Gas_Error()
        {
            ...
            state.Verify(s => s.CreateSmartContractState(state.Object, It.IsAny<ReadWriteSetBuilder>(), It.IsAny<ReadWriteSetBuilder>(), It.IsAny<RuntimeObserver.IGasMeter>(), callMessage.To, callMessage, this.contractStateRoot.Object));
        ...
        public void Contract_Transfer_To_Other_Contract_Success()
        {
            ...
            // Verify we set up the smart contract state
            state.Verify(s => s.CreateSmartContractState(state.Object, It.IsAny<ReadWriteSetBuilder>(), It.IsAny<ReadWriteSetBuilder>(), It.IsAny<RuntimeObserver.IGasMeter>(), contractTransferMessage.To, contractTransferMessage, this.contractStateRoot.Object));
