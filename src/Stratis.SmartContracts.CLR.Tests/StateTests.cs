...
namespace Stratis.SmartContracts.CLR.Tests
{
    public class StateTests
    {
        ...
        {
            var state = new State(null, this.contractStateRoot.Object, this.contractLogHolder.Object, new List<TransferInfo>(), null, null, null, null);
        ...
        public void State_Snapshot_Has_New_InternalTransfers_With_Original_Transfers()
        {
            ...
            var state = new State(null, this.contractStateRoot.Object, this.contractLogHolder.Object, transfers, null, null, null, null);
