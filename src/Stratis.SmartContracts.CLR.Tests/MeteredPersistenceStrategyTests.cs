...
namespace Stratis.SmartContracts.CLR.Tests
{
    public class MeteredPersistenceStrategyTests
    {
        ...
        public void SmartContracts_MeteredPersistenceStrategy_TestNullInjectedArgsThrow()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new MeteredPersistenceStrategy(null, new GasMeter((RuntimeObserver.Gas) 0), this.keyEncodingStrategy, new ReadWriteSetBuilder(),  "1.1"));
            Assert.Throws<ArgumentNullException>(() => new MeteredPersistenceStrategy(sr.Object, null, this.keyEncodingStrategy, new ReadWriteSetBuilder(),  "1.1"));
        }
