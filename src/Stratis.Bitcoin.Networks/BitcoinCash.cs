...
{
    public class BitcoinCash : Network
    {
        public BitcoinCash()
        {
            this.Name = "Main";
            ...
            var buriedDeployments = new BuriedDeploymentsArray
            {
                ...
                [BuriedDeployments.CashHardFork] = 478558
            };
            ...
            // TODO: These rules are actually more complex - check here https://github.com/bitcoincashorg/bitcoincash.org/blob/master/spec/uahf-technical-spec.md

            var cashConsensusOptions = new ConsensusOptions(
                32_000_000,
                2,
                1_000_000,
                640_000,
            ...
            this.Consensus = new NBitcoin.Consensus(
                ...
                consensusOptions: cashConsensusOptions,
                coinType: 0,
            ...
            // Confident we don't need the commented out...
            ...
            {
                new DNSSeedData("ABC", "seed.bitcoinabc.org"),
                new DNSSeedData("BitcoinForks", "seed-abc.bitcoinforks.org"),
                new DNSSeedData("BU", "btccash-seeder.bitcoinunlimited.info"),
                new DNSSeedData("BitPrim", "seed.bitprim.org"),
                new DNSSeedData("Amaury", "seed.deadalnix.me"),
                new DNSSeedData("Criptolayer", "seeder.criptolayer.net")
            };
        ...
        public const string BitcoinRootFolderName = "bitcoincash";
