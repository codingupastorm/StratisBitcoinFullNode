...
namespace Unbreakable.Internal
{
    internal class AssemblyValidator {
        ...
        public AssemblyValidator(
            ...
            _settings = settings; //Argument.NotNull(nameof(settings), settings);
            _userAssembly = userAssembly; // Argument.NotNull(nameof(userAssembly), userAssembly);
            _stackSizeValidator = stackSizeValidator; // Argument.NotNull(nameof(stackSizeValidator), stackSizeValidator);
            _pointerValidator = pointerValidator; // Argument.NotNull(nameof(pointerValidator), pointerValidator);
        }
