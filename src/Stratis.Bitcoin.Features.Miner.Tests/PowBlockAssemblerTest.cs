    ...
    public class PowBlockAssemblerTest : LogsTestBase
    {
        ...
        public void CreateNewBlock_WithScript_ReturnsBlockTemplate()
        {
            this.ExecuteWithConsensusOptions(new ConsensusOptions(), () =>
            {
                ...
                var blockDefinition = new PowBlockDefinition(this.consensusManager.Object, this.dateTimeProvider.Object, this.LoggerFactory.Object, this.txMempool.Object, new MempoolSchedulerLock(), this.minerSettings, this.testNet);
        ...
        public void ComputeBlockVersion_UsingChainTipAndConsensus_Bip9DeploymentActive_UpdatesHeightAndVersion()
        {
            ...
            int minerConfirmationWindow = this.testNet.Consensus.ConsensusMiningReward.MinerConfirmationWindow;
            ...
            try
            {
                ...
                this.testNet.Consensus.ConsensusMiningReward.MinerConfirmationWindow = 2;
            ...
            finally
            {
                ...
                this.testNet.Consensus.ConsensusMiningReward.MinerConfirmationWindow = minerConfirmationWindow;
            }
        }
