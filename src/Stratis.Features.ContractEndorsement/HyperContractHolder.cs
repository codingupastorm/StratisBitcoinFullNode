...
{
    public class HyperContractHolder : IHyperContract
    {
        /// <summary>
        ...
        private readonly HyperContract instance;
        ...
        /// <inheritdoc />
        public IHyperContractState State { get; }
        ...
        private HyperContractHolder(HyperContract instance, Type type, IHyperContractState state, uint160 address)
        {
        ...
        /// </summary>
        public static IHyperContract CreateUninitialized(Type type, IHyperContractState state, uint160 address)
        {
            var contract = (HyperContract)FormatterServices.GetSafeUninitializedObject(type);

            return new HyperContractHolder(contract, type, state, address);
        }
        ...
        /// </summary>
        private static void SetStateField(HyperContract smartContract, IHyperContractState contractState)
        {
